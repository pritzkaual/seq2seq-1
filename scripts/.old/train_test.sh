...
LEARNING_RATE=${LEARNING_RATE:-0.0008}  # 0.0001
...
EXPERIMENT_NO=${EXPERIMENT_NO:-2.0}

export MODEL_DIR=${MODEL_DIR}/exp${EXPERIMENT_NO}.${MODEL_SIZE}.${DATASET_TYPE}.${MODEL_TYPE}.lr${LEARNING_RATE}
...
python -m bin.train \
  ...
  --source_embedding ${SOURCE_EMBEDDING_PATH} \
